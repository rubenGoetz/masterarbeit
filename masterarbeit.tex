...
%In the following, we will first define the theoretical SAT problem in section \ref{sec:SATproblem} and then some terminology commonly used, when discussing so called SAT solvers in section \ref{sec:solverNotation}.
...
%\subsubsection{SAT-Solver Terminology}
...
When a conflict is found, the solver backtracks to a point, at which no conflict remains. If no satisfying assignment can be found in this way, the solver reports the formula to be unsatisfiable. Most modern SAT solvers regularly \textit{restart} their search routines, to avoid wasting time on bad branching decisions that happen early on. Like decition heuristics, a good restarting strategy is an integral part of modern SAT solvers (see e.g. \cite{gomes1998boosting, gomes2000heavy, oh2015between}). Modern solvers also include sophisticated \textit{pre- and inprocessing} techniques \cite{biere2021preprocessing}, to reduce a problem's complexity before and in between their CDCL loops.
...
\end{itemize}
TODO: adapt concrete numbers for experiments with new import strategy

In our experiments, configuration $B$ solved 10 benchmark instances that configuration $A$ did not solve within a 300s time limit. Of these 10 instances, 7 were SAT and thus some of them may be attributed to lucky non-determinism. Configuration $B$ solved 3 instances that configuration $A$ could not solve within the time limit. We opted for the configuration $A$ mainly for its significantly more efficient memory usage as shown in Figure \ref{fig:2nodeConfigMemCompare}.

% TODO: fix plot
\begin{figure}
  \center
  \includegraphics[scale=.5]{plots/config_compare/1node_config_compare.png}
...
\begin{figure}
  ...
  \caption{Speedups of our Algorithm. Per instance on the left, accumulated on the right. TODO: make plot pretty}
  \label{fig:speedups}
\end{figure}
...
\begin{table}
  ...
  \begin{tabular}{ lcccccc }
    ...
    \midrule
    coloring	                  &	8	  &	-	      &	-	      &	-	      &	-	      &	-\\
    heule-folkman	              &	11	&	0.486	  &	-1.0	  &	0.416	  &	0.449	  &	0.444\\
    cryptography-simon	        &	10	&	0.219	  &	0.234	  &	0.227	  &	0.2	    &	0.18\\
    miter	                      &	47	&	1.738	  &	1.835	  &	1.997	  &	2.25	  &	2.013\\
    random-circuits	            &	15	&	3.176	  &	3.095	  &	3.527	  &	3.849	  &	3.839\\
    planning	                  &	6	  &	2.573	  &	3.977	  &	4.168	  &	4.623	  &	4.835\\
    software-verification	      &	15	&	2.253	  &	5.073	  &	4.248	  &	4.57	  &	4.71\\
    tseitin-formulas	          &	8	  &	4.768	  &	4.567	  &	5.177	  &	5.275	  &	5.49\\
    hardware-verification	      &	5	  &	4.608	  &	5.369	  &	5.556	  &	6.036	  &	6.161\\
    scheduling	                &	50	&	4.964	  &	6.434	  &	7.944	  &	8.384	  &	8.799\\
    heule-nol	                  &	11	&	5.896	  &	11.793	&	7.786	  &	10.231	&	12.876\\
    cryptography-ascon	        &	6	  &	7.502	  &	8.273	  &	10.115	&	8.709	  &	14.008\\
    quantum-kochen-specker	    &	10	&	9.283	  &	11.237	&	11.186	&	11.137	&	11.005\\
    maxsat-optimum	            &	13	&	7.797	  &	7.32	  &	12.362	&	13.762	&	14.899\\
    cryptography	              &	7	  &	6.98	  &	16.922	&	9.289	  &	21.402	&	23.632\\
    hamiltonian	                &	40	&	9.402	  &	14.409	&	19.398	&	23.315	&	26.351\\
    argumentation	              &	21	&	12.448	&	16.268	&	18.577	&	21.941	&	20.716\\
    independent-set	            &	15	&	17.084	&	18.038	&	20.981	&	27.173	&	25.9\\
    minimum-disagreement-parity	&	17	&	32.697	&	22.119	&	24.766	&	46.884	&	58.316\\
    rbsat	                      &	5	  &	49.344	&	64.654	&	76.039	&	186.204	&	221.286\\
    \bottomrule
  \end{tabular}
...
In the following, we denote benchmark instances that have been solved by all solvers in a given context as \textit{solved instances}. Conversely, we denote instances that have not been solved by at least one solver in a given context as \textit{un- or partially solved instances}.
...
% TODO: fixe data for 1node
The exact memory consumption of our approach, as well as MallobSat's, is shown in Figure \ref{fig:memAbsVars}. The mean memory consumptions across all instances are shown in Table \ref{tab:memMean}. For solved instances, we find the ratio between MallobSat's mean memory consumption and that of our approach to be $1.872$ for 1 node, $1.881$ for 4 nodes, and $1.883$ for 16 nodes. For all instances, we find the ratios to be slightly smaller: $1.897$ for 1 node, $1.655$ for 4 nodes, and $1.722$ for 16 nodes.
...
\begin{longtable}{ lccccccc }
  ...
  fermat	                        &	1	  &	-	      &	-	&	-	&	-	&	-	\\
  sgen	                          &	2	  &	-	      &	-	&	-	&	-	&	-	\\
  heule-folkman	                  &	11	&	0.486	  &	-	&	0.416	&	0.449	&	0.444	\\
  clique-width	                  &	1	  &	-	      &	-	&	-	&	-	&	-	\\
  ...
  cryptography-simon	            &	10	&	0.219   &	0.234	&	0.227	&	0.2	&	0.18\\
  subgraph-isomorphism	          &	4	  &	1.219   &	1.669	&	1.844	&	1.93	&	1.851	\\
  puzzle	                        &	1	  &	1.581   &	1.767	&	1.78	&	1.85	&	1.95	\\
  miter	                          &	47	&	1.738   &	1.835	&	1.997	&	2.25	&	2.013	\\
  st-connectivity-principle	      &	2	  &	2.651   &	1.592	&	2.425	&	2.598	&	2.44	\\
  automata-synchronization	      &	1	  &	2.694   &	3.149	&	3.254	&	3.37	&	3.271	\\
  random-circuits	                &	15	&	3.176   &	3.095	&	3.527	&	3.849	&	3.839	\\
  clique-formulas	                &	1	  &	3.452   &	3.364	&	3.772	&	4.142	&	3.748	\\
  graph-isomorphism	              &	1	  &	3.292   &	3.791	&	3.476	&	4.226	&	3.88	\\
  cellular-automata	              &	2	  &	3.082   &	3.529	&	3.836	&	4.271	&	4.208	\\
  stedman-triples	                &	2	  &	2.1	    &	2.783	&	3.821	&	7.486	&	4.85	\\
  planning	                      &	6	  &	2.573	  &	3.977	&	4.168	&	4.623	&	4.835	\\
  bitvector	                      &	4	  &	3.103	  &	3.788	&	3.984	&	4.55	&	4.813	\\
  software-verification	          &	15	&	2.253	  &	5.073	&	4.248	&	4.57	&	4.71	\\
  random-modularity	              &	1	  &	2.233	  &	3.31	&	5.157	&	11.028	&	6.742 \\
  tseitin-formulas	              &	8	  &	4.768	  &	4.567	&	5.177	&	5.275	&	5.49\\
  erdos-discrepancy	              &	1	  &	2.216	  &	4.83	&	6.517	&	7.707	&	7.387\\
  hardware-verification	          &	5	  &	4.608	  &	5.369	&	5.556	&	6.036	&	6.161\\
  summle	                        &	3	  &	2.857	  &	5.851	&	6.863	&	7.176	&	7.739\\
  equivalence-chain-principle	    &	4	  &	4.899	  &	5.462	&	6.263	&	6.88	&	7.626\\
  or\_randxor	                    &	1	  &	5.818	  &	6.23	&	7.48	&	7.253	&	7.396\\
  scheduling	                    &	50	&	4.964	  &	6.434	&	7.944	&	8.384	&	8.799\\
  rooks	                          &	3	  &	7.324	  &	8.56	&	6.281	&	7.858	&	7.899\\
  mutilated-chessboard	          &	3	  &	7.906	  &	5.276	&	7.803	&	8.323	&	9.425\\
  grs-fp-comm	                    &	2	  &	7.171	  &	7.939	&	9.583	&	10.425	&	10.679\\
  heule-nol	                      &	11	&	5.896	  &	11.793	&	7.786	&	10.231	&	12.876\\
  cryptography-ascon	            &	6	  &	7.502	  &	8.273	&	10.115	&	8.709	&	14.008\\
  popularity-similarity	          &	1	  &	10.449	&	10.371	&	10.352	&	10.474	&	10.816\\
  quantum-kochen-specker	        &	10	&	9.283	  &	11.237	&	11.186	&	11.137	&	11.005\\
  maxsat-optimum	                &	13	&	7.797	  &	7.32	&	12.362	&	13.762	&	14.899\\
  reg-n	                          &	4	  &	0.545	  &	28.761	&	26.837	&	26.765	&	27.78\\
  quasigroup-completion	          &	2	  &	5.18	  &	6.998	&	12.279	&	30.304	&	32.551\\
  cryptography	                  &	7	  &	6.98	  &	16.922	&	9.289	&	21.402	&	23.632\\
  ramsey	                        &	1	  &	12.11	  &	18.278	&	18.859	&	19.927	&	19.178\\
  hamiltonian	                    &	40	&	9.402	  &	14.409	&	19.398	&	23.315	&	26.351\\
  argumentation	                  &	21	&	12.448	&	16.268	&	18.577	&	21.941	&	20.716\\
  battleship	                    &	1	  &	10.065	&	11.49	&	22.608	&	38.895	&	28.755\\
  independent-set	                &	15	&	17.084	&	18.038	&	20.981	&	27.173	&	25.9\\
  pythagorean-triples	            &	1	  &	9.899	  &	23.726	&	24.031	&	96.261	&	28.008\\
  crafted-cec	                    &	1	  &	22.625	&	28.202	&	30.506	&	34.541	&	45.252\\
  minimum-disagreement-parity	    &	17	&	32.697	&	22.119	&	24.766	&	46.884	&	58.316\\
  polynomial-multiplication	      &	4	  &	21.641	&	34.021	&	22.424	&	24.579	&	121.641\\
  random-csp	                    &	2	  &	19.592	&	31.507	&	32.744	&	71.948	&	98.142\\
  unknown	                        &	1	  &	24.193	&	29.251	&	89.022	&	103.831	&	120.212\\
  circuit-multiplier	            &	1	  &	51.034	&	105.262	&	33.202	&	82.974	&	264.479\\
  influence-maximization	        &	1	  &	42.347	&	96.668	&	43.252	&	145.409	&	279.558\\
  rbsat	                          &	5	  &	49.344	&	64.654	&	76.039	&	186.204	&	221.286\\
  tree-decomposition	            &	1	  &	542.903	&	73.685	&	70.701	&	174.601	&	485.546\\
  \bottomrule
