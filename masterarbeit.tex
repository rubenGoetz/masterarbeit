...
% TODO: and utilizing clause filtering
...
% Find most scalable limit. will be Threads or half pool (constant number)

% import t clauses per importing operation
% import only so many clauses as can fit in fullest internal buffer
% import only so many clauses as can fit in second fullest buffer
% import half of buffer size many clauses
% import mean free slots in buffers many clauses
